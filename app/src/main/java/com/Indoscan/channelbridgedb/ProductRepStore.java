...
//			Log.w("productData 15:", cursor.getString(15));
    ...
    public long updateProductRepstore(String batchNo, String quantity, String expiryDate, String timestamp, String productId,String pPrice,String sellPrice,String retailPrice) throws SQLException {
        ContentValues cv = new ContentValues();
    ...
    public boolean isBatchAvailable(String batch, String prodId,String exdate,String pPrice,String sPrice,String rPrice) {

        Cursor cursor = database.query(TABLE_NAME, columns, KEY_BATCH_NO + "=? AND " + KEY_PRODUCT_CODE + "=? AND "+KEY_EXPIRY_DATE+"=? AND "+KEY_PURCHASE_PRICE+"=? AND "+KEY_SELLING_PRICE+"=? AND "+KEY_RETAIL_PRICE+" =? ", new String[]{batch, prodId,exdate,pPrice,sPrice,rPrice}, null, null, null);
        cursor.moveToFirst();
